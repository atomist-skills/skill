...
*   Add credentials resolution helpers. [#65](https://github.com/atomist-skills/skill/issues/65)
...
*   Missing staging support in Datalog query client. [#429](https://github.com/atomist-skills/skill/issues/429)
